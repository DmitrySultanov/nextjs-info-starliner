'use client'
import { Box, Button, Container, Grid, Typography, TextField, Checkbox } from '@mui/material';
...
const TryStarlinerFree = () => {
    ...
    return (
        <Box component="section" className={styles.TryStarlinerFree} id="TryStarlinerFree">
            <Container maxWidth="lg">
                <Grid container justifyContent="center">
                    <Grid item xs={12} md={8} lg={6}>
                        <Typography component="h2" className='section-title' style={{color: '#fff'}}>Попробуй Starliner бесплатно</Typography>
...
export default TryStarlinerFree;
